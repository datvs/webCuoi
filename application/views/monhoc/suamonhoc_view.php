	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 text-sm-center">
				...
				<strong><h2>Sửa Môn Học</h2></strong>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 push-sm-3">
				<form action="<?= base_url() ?>Monhoc/sua" method="post">
					<?php foreach ($data_suamonhoc as $value): ?>
						<input type="hidden" name="id" value="<?= $value['id'] ?>">
				
					<fieldset class="form-group form-control">
						<label style="color: #E91E63">Mã Môn Học:</label>
						<input name="mamonhoc" type="text" class="form-control form-group" id="mamonhoc" value="<?= $value['mamonhoc'] ?>">
					</fieldset>

					<fieldset class="form-group form-control">
						<label style="color: #E91E63">Tên Môn Học:</label>
						<input name="tenmonhoc" type="text" class="form-control form-group" id="tenmonhoc" value="<?= $value['tenmonhoc'] ?>">
					</fieldset>

					<fieldset class="form-group form-control">
						<label style="color: #E91E63">Số Tín Chỉ:</label>
						<input name="sotinchi" type="text" class="form-control form-group" id="sotinchi" value="<?= $value['sotinchi'] ?>">
					</fieldset>
